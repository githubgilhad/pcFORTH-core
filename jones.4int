...
: CONSTANT WORD CREATE DOCOL , ' LIT , C>D , ' EXIT , ;
: CONSTANT2 WORD CREATE DOCOL , ' LIT , , ' EXIT , ;
: ALLOT HERE D@ SWAP12 HERE +! ;
: CELLS LIT \'0x00000002 * ;
: VARIABLE LIT \'0x00000002 CELLS ALLOT WORD CREATE DOCOL , ' LIT2 , , ' EXIT , ;
: VALUE WORD CREATE DOCOL , ' LIT , C>D , ' EXIT , ;
: VALUE2 WORD CREATE DOCOL , ' LIT2 , , ' EXIT , ;
